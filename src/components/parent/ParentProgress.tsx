...
const ParentProgress = () => {
  ...
  const activeChild = useMemo(
      () =>
          children.find((c) => c.studentId === selectedChildId) ||
          null,
      [children, selectedChildId]
  );
  ...
  const {
    ...
    queryFn: () =>
        reportsService.progressByUser(selectedChildId as string),
  ...
  const {
    ...
    queryFn: () =>
        parentService.childQuizResults(selectedChildId as string),
    enabled: !!selectedChildId,
  });
        ...
        <div className="p-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                No children are linked to your account yet. Please
                contact the school or administrator.
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
