...
const ParentStudentOverview = () => {
    ...
    const overview = useMemo(() => {
        ...
        // Placeholder – real schedule can plug in here later
                ...
                <Card className="border-red-200 bg-red-50">
                    <CardHeader>
                        ...
                        <CardDescription className="text-red-700">
                            We couldn&apos;t load your child profiles. Please try again
            ...
            <div className="p-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Your account does not have any children assigned. Please
                            contact the school or administrator to link your child to
                            Happy Path.
                        </CardDescription>
                    </CardHeader>
                </Card>
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="md:col-span-2 shadow-sm border border-happy-50">
                    <CardHeader className="pb-3">
                        <div className="flex items-center justify-between gap-4">
                            <div>
                                <div className="inline-flex items-center gap-2 rounded-full bg-happy-50 px-3 py-1 text-xs text-happy-800 mb-2">
                            ...
                            <div className="hidden md:block text-right">
                                ...
                                <select
                                    className="mt-1 block rounded-md border border-gray-300 bg-white px-2 py-1 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-happy-500"
                    ...
                    <CardContent>
                        <div className="flex flex-col md:flex-row gap-6">
                            ...
                            <div className="flex-1 space-y-4">
                                <div>
                                    ...
                                    <ProgressBar
                                        ...
                                        className="h-2 bg-gray-200 [&>div]:bg-green-500 rounded-full"
                                    />
                                </div>


                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div className="flex items-start gap-3 rounded-lg bg-happy-50/60 px-3 py-2">
                          ...
                          of {overview.totalModules}
                                    ...
                                    <div className="flex items-start gap-3 rounded-lg bg-blue-50/70 px-3 py-2">
                                        <div className="rounded-full bg-white p-1.5 shadow-sm">
                        ...
                        <span className={attentionInfo.color}>
                          {attentionInfo.label}
                                    ...
                                    <div className="flex items-start gap-3 rounded-lg bg-emerald-50/70 px-3 py-2">
                                        <div className="rounded-full bg-white p-1.5 shadow-sm">
                                    ...
                                    <div className="flex items-start gap-3 rounded-lg bg-sky-50/70 px-3 py-2">
                                        <div className="rounded-full bg-white p-1.5 shadow-sm">
                        ...
                        <div className="mt-4 md:hidden">
                            ...
                            <select
                                className="mt-1 block w-full rounded-md border border-gray-300 bg-white px-2 py-1 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-happy-500"
                                value={overview.child.studentId}
                                onChange={(e) =>
                                    setSelectedChildId(e.target.value || null)
                                }
                ...
                {/* Upcoming activities (placeholder for future schedule) */}
                    ...
                    <CardContent>
                        {overview.upcomingActivities.length === 0 ? (
                            <p className="text-sm text-muted-foreground">
                                No specific activities scheduled yet. Encourage your child
                                to continue with their next lesson.
                            </p>
                        ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="shadow-sm">
                    ...
                    <CardContent className="h-[320px]">
                        {selectedChildId ? (
                            // Cast to any to satisfy existing StudentPerformanceChartProps
                            <StudentPerformanceChart
                                {...({ studentId: selectedChildId } as any)}
                            />
                        ) : (
                            <p className="text-sm text-muted-foreground">
                ...
                <Card className="shadow-sm">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Last 7 days attention and emotion tracking
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="h-[320px]">
                        {selectedChildId ? (
                            // Cast to any to satisfy existing StudentEmotionChartProps
                            <StudentEmotionChart
                                {...({ studentId: selectedChildId } as any)}
                            />
                        ) : (
                            <p className="text-sm text-muted-foreground">
                                Select a child to view trends.
                            </p>
                        )}
                    </CardContent>
                </Card>
